...
export const turningConversations: TrainingModule = {
  ...
  title: "Recognising domestic abuse and responding with compassion",
  description:
  ...
  steps: [
    {
      ...
      title: "Recognising domestic abuse and responding with compassion",
      subtitle: "Turning everyday salon conversations into lifelines",
      blocks: [
        {
          kind: "card",
          body: "This training takes around **20 minutes**. Your progress is saved to your account, so you can leave and pick up where you left off at any time, on any device.",
        },
        {
          kind: "card",
          body: "A gentle warning before we begin. This training speaks openly about domestic abuse, including emotional, financial, physical and sexual abuse. For some of us this is not a distant subject. It may be your own story, or that of someone you love.\n\nThat is okay, and you are welcome here. You can **pause at any time** and your place is saved. If it ever becomes too much, you can stop, or use the **Exit site** button in the bottom corner to leave this page instantly.",
        },
        {
          kind: "note",
          body: "**About the “Exit site” button:** it sits in the bottom right of every page. Clicking it will immediately take you away from this training to a neutral website. It's there for anyone who needs to close this page quickly and discreetly.",
        },
        {
          kind: "note",
